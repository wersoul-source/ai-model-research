...
> Session: 2026-08-20-S39 | Skill: diagnose-gemma-4 | ขนาดไฟล์: 181 bytes

## 1. ภาพรวม

ไฟล์เล็กที่สุดในชุด (181 bytes) แต่สำคัญ — กำหนด **ค่า default ที่ใช้ตอน `model.generate()`** ถ้าโค้ดไม่ระบุค่าเอง จะใช้ค่าจากไฟล์นี้
